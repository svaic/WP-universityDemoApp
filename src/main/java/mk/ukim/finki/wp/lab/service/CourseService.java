...
public class CourseService implements ICourseService {
    ...
    public CourseService(StudentService studentService, CourseRepository courseRepository, GradeRepository gradeRepository) {
    ...
    public List<Course> searchCourses(String text) {
        return courseRepository.findCourseByDescriptionContainingIgnoreCaseOrNameContainingIgnoreCase(text,text);
    }
